...
## Run
sbatch --mail-user=daniel.kerber@students.unibe.ch --mail-type=BEGIN,FAIL,END --job-name="Diabetes test" --mem-per-cpu=32G --cpus-per-task=1 --wrap="python3 /src/main.py"